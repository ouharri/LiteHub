...
<div
    ...
    <!-- Right Sidebar -->
    <aside class="w-1/4 py-10 px-10  min-w-min hidden lg:block ">

        @yield('bookDetails')

        <div class="mt-10">
            <span class="font-semibold text-gray-700 dark:text-white">Similaire Book</span>
            <ul class="mt-4 text-gray-400 text-xs space-y-3">
                ...
                <li class="pt-1">
                    <a href="#" class="px-5 py-2.5 bg-[#68D391]  hover:bg-[#FFDB58] rounded-lg text-center font-medium block text-white">See More</a>
                </li>
